...
/**
 * Runs automatically after: npm install -g wac-devflow
 *
...
if (!isInteractive || isCI || isSkipped) {
  console.log('\n  devflow-cli installed. Run "devflow setup" to configure.\n');
  process.exit(0);
}
...
if (allSet) {
  console.log('\n  devflow-cli: already configured. Run "devflow check" to verify.\n');
  process.exit(0);
}

// ── Launch setup wizard ────────────────────────────────────────────────────────
console.log('\n  devflow-cli: launching setup wizard...\n');
